...
__export(index_exports, {
  CLASS_SPACING_MESSAGE_IDS: () => CLASS_SPACING_MESSAGE_IDS,
  NO_DUPLICATE_CLASS_MESSAGE_IDS: () => NO_DUPLICATE_CLASS_MESSAGE_IDS,
  NO_INEFFECTIVE_ATTRS_MESSAGE_IDS: () => NO_INEFFECTIVE_ATTRS_MESSAGE_IDS,
  NO_INVALID_ATTR_VALUE_MESSAGE_IDS: () => NO_INVALID_ATTR_VALUE_MESSAGE_IDS,
  NO_OBSOLETE_ATTRS_MESSAGE_IDS: () => NO_OBSOLETE_ATTRS_MESSAGE_IDS,
  NO_OBSOLETE_TAGS_MESSAGE_IDS: () => NO_OBSOLETE_TAGS_MESSAGE_IDS,
  USE_BASELINE_MESSAGE_IDS: () => USE_BASELINE_MESSAGE_IDS,
  classSpacing: () => classSpacing,
  noDuplicateClass: () => noDuplicateClass,
  noIneffectiveAttrs: () => noIneffectiveAttrs,
  noInvalidAttrValue: () => noInvalidAttrValue,
  noObsoleteAttrs: () => noObsoleteAttrs,
  noObsoleteTags: () => noObsoleteTags,
  useBaseline: () => useBaseline
});
module.exports = __toCommonJS(index_exports);

// lib/rules/no-invalid-attr-value.js
var import_html_standard = require("html-standard");
...
function noInvalidAttrValue(options) {
  ...
  return {
    ...
    checkAttributes(adapter) {
      ...
      const spec = (0, import_html_standard.element)(name);
      const result = [];
...
var elements = /* @__PURE__ */ new Map([
  ...
  ["button.commandfor.implicit_anchor_reference", "5:2026"],
  ...
  ["button.interestfor", "0:"],
  ["button.name", "10:2015"],
  ["button.popovertarget", "5:2024"],
  ["button.popovertarget.implicit_anchor_reference", "5:2026"],
  ...
  ["data.value", "10:2017"],
  ["datalist", "0:"],
  ["datalist.input_type_color", "0:"],
  ["datalist.input_type_date", "0:"],
  ["datalist.input_type_email", "0:"],
  ["datalist.input_type_number", "0:"],
  ["datalist.input_type_range", "0:"],
  ["datalist.input_type_search", "0:"],
  ["datalist.input_type_tel", "0:"],
  ["datalist.input_type_text", "0:"],
  ["datalist.input_type_time", "0:"],
  ["datalist.input_type_url", "0:"],
  ["dd", "10:2015"],
  ["del", "10:2015"],
  ["del.cite", "10:2015"],
  ...
  ["iframe.allow.browsing-topics", "0:"],
  ...
  ["iframe.sandbox.allow-downloads", "10:2023"],
  ...
  ["input.popovertarget.implicit_anchor_reference", "5:2026"],
  ...
  ["input.type_search.list", "10:2019"],
  ["input.type_submit", "10:2015"],
  ["input.type_tel", "10:2015"],
  ["input.type_tel.list", "10:2019"],
  ["input.type_text", "10:2015"],
  ["input.type_text.list", "10:2019"],
  ["input.type_time", "10:2021"],
  ["input.type_time.list", "0:"],
  ["input.type_url", "10:2015"],
  ["input.type_url.list", "10:2019"],
  ["input.type_week", "0:"],
  ["input.webkitdirectory", "5:2025"],
  ["ins", "10:2015"],
  ["ins.cite", "10:2015"],
  ...
  ["link.imagesizes", "10:2023"],
  ["link.imagesrcset", "10:2023"],
  ...
  ["link.rel.expect", "0:"],
  ["link.rel.manifest", "0:"],
  ["link.rel.modulepreload", "10:2023"],
  ...
  ["script.integrity.ed25519_public_key", "0:"],
  ...
  ["template.shadowrootcustomelementregistry", "0:"],
  ...
  ["template.shadowrootslotassignment", "0:"],
  ["textarea", "10:2015"],
  ["textarea.autocomplete", "10:2020"],
  ["textarea.cols", "10:2015"],
  ["textarea.dirname", "10:2023"],
...
function useBaseline({ available }) {
    ...
    checkAttributes(adapter) {
      ...
      for (const attribute of adapter.getAttributes()) {
        ...
        if (!isSupportedElementAttributeKey(elementName, attributeKeyValue)) {
          ...
          } else if (!isSupportedGlobalAttributeKeyValue(
            attributeKeyValue,
            attributeValueValue || ""
          )) {
            result.push({
...
function noIneffectiveAttrs() {
  ...
  function isAttrValueExpression(adapter, attrName) {
    return adapter.getAttributes().some((attr) => {
      ...
      return key?.getValue() === attrName && !!attr?.getValue()?.hasExpression();
    });
  }
  const checkersByTag = {
    input: [
    ...
    checkAttributes(adapter) {
      ...
      for (const check of tagCheckers) {
        for (const attribute of adapter.getAttributes()) {
          ...
          const attributeKeyValue = attributeKey.getValue();
          const attributeValueValue = attributeValue?.getValue();
          if (attributeValueValue === null || attributeKeyValue?.toLowerCase() !== check.attr) {
            continue;
          }
  ...
  return {
    ...
    checkAttributes(adapter) {
      ...
      for (const attribute of adapter.getAttributes()) {
        ...
        if (attributeKey.hasExpression() || attrKeyValue === null || attrValueValueValue === null) {
          continue;
        }
...
// lib/rules/class-spacing.js
var CLASS_BETWEEN_EXTRA_SPACES_REGEX = /\s{2,}/;
var CLASS_BETWEEN_EXTRA_SPACES_REGEX_GLOBAL = /\s{2,}/g;
var LINE_BREAK_REGEX = /\r\n|[\r\n\u2028\u2029]/u;
var CLASS_SPACING_MESSAGE_IDS = {
...
// lib/rules/no-duplicate-class.js
var NO_DUPLICATE_CLASS_MESSAGE_IDS = {
...
function noDuplicateClass() {
  return {
    ...
    checkClassValue(classValue) {
      ...
      classesAndSpaces.forEach(({ value: value2, pos }) => {
        const className = value2.trim();
        if (className.length) {
          if (classSet.has(className)) {
            ...
            const classEnd = {
              line: loc.start.line,
              column: loc.start.column + pos + value2.length
            };
            result.push({
              ...
              range: [range[0] + pos, range[0] + pos + value2.length],
              data: {
                className
              }
            });
