import type { Document, Attribute, AttributeKey, AttributeValue, AttributeValueWrapperEnd, AttributeValueWrapperStart, CloseScriptTag, CloseStyleTag, CloseTag, CommentContent, Comment, CommentOpen, CommentClose, Doctype, DoctypeAttribute, DoctypeAttributeValue, DoctypeAttributeWrapperEnd, DoctypeAttributeWrapperStart, DoctypeOpen, DoctypeClose, OpenScriptTagEnd, OpenScriptTagStart, OpenStyleTagEnd, OpenStyleTagStart, OpenTagEnd, OpenTagStart, ScriptTag, ScriptTagContent, StyleTag, StyleTagContent, Tag, Text } from "@html-eslint/types";
...
type BaseVisiter = Partial<{
    ...
    [NodeTypes.AttributeValueWrapperEnd]: (node: AttributeValueWrapperEnd) => void;
    [NodeTypes.AttributeValueWrapperStart]: (node: AttributeValueWrapperStart) => void;
    ...
    [NodeTypes.DoctypeAttributeWrapperEnd]: (node: DoctypeAttributeWrapperEnd) => void;
    [NodeTypes.DoctypeAttributeWrapperStart]: (node: DoctypeAttributeWrapperStart) => void;
